...
<head>
    ...
    <link rel="shortcut icon" href="./css/trang-chu/img/logooo.png">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            <h2
                                style="font-size:40px;font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif">
                                Big Shoes</h2>
                            <nav class="main_nav">
                            ...
                            <div class="header_extra ml-auto">
                                <div class="shopping_cart">
                                    ...
                                    <div>
                                        <a href="trang-chinh/danh-sach-gio-hang.php">
                                            ...
                                            <span class="badge rounded-pill badge-danger "><?= $sll ?></span>
                                        </a>
                                    </div>
                                </div>
                                <div class="search">
                                ...
                                <div class="icon_user">
                                    ...
                                    ?>
                                    <a class="login1" href="tai-khoan/dang-nhap.php"
                                        style="color: black; text-decoration: none;">
                                        <button type="button" class="btn btn-success">Đăng nhập</button>
                                    </a>
                                    <?php else: ?>
                                    <a id="login" href="tai-khoan/thong-tin-tk.php"
                                        style="color: black; text-decoration: none;">
    ...
    <div class="container" style="margin-top: 30px;">
        <div class="row">
            ...
            <div class="col-md-3" style="margin-bottom: 30px;">
                <div class="card">
                    <a href="chi-tiet-sp.php?ma_hh=<?= $ma_hh ?>"><img class="card-img-top"
